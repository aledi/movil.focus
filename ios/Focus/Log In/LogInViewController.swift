                ...
                for object in panels {
                    ...
                    for object2 in panel["encuestas"] as! [AnyObject] {
                        ...
                        for object3 in survey["preguntas"] as! [AnyObject] {
                            ...
                            let newQuestion = Pregunta(id: question["id"] as! Int, tipo: question["tipo"] as! Int, numPregunta: question["numPregunta"] as! Int, titulo: question["titulo"] as! String, pregunta: question["pregunta"] as! String, video: question["video"] as! String, imagen: question["imagen"] as! String, opciones: question["opciones"] as! [String])
