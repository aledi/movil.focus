...
extension NSUserDefaults {
    ...
    static func retreiveUserDefaults() -> User? {
        ...
        guard let id = defaults.objectForKey("id") as? Int, username = defaults.objectForKey("username") as? String, genero = defaults.objectForKey("genero") as? Int, email = defaults.objectForKey("email") as? String, nombre = defaults.objectForKey("nombre") as? String, _ = defaults.objectForKey("token") as? String else {
            return nil
        }
