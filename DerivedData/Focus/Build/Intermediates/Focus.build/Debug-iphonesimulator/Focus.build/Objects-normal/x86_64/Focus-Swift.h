...
SWIFT_CLASS("_TtC5Focus11AppDelegate")
...
SWIFT_CLASS("_TtC5Focus19LogInViewController")
...
- (void)didFinishRequest:(NSDictionary * _Nonnull)response;
...
@interface UIViewController (SWIFT_EXTENSION(Focus))
- (AppDelegate * _Nonnull)appDelegate;
@end


SWIFT_CLASS("_TtC5Focus14ViewController")
